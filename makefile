...
deploy:
	...
	# bash --login -c "cd /srv/redis-io && rvm use 2.7.0 &&PHARMAVILLAGE_DOC=/srv/redis-doc /srv/redis-io/scripts/generate_interactive_commands.rb > /srv/redis-io/lib/interactive/commands.rb"
